...
export async function getStockAndroidMany (): Promise<
  StockAndroidInclude[] | undefined
> {
  try {
...
export async function getStockAndroidPagination (
  pageNumber: number,
  pageSize: number
): Promise<StockAndroid[] | undefined> {
  try {
