...
export default function SignInForm({ handleSignIn }: { handleSignIn: () => void }) {
    return (
        <div className="relative mx-auto max-w-lg overflow-hidden rounded-lg bg-white py-16 px-10 text-center sm:px-12 md:px-[60px] mt-20">
            ...
            <ul className="-mx-2 mb-12 flex justify-between">
                <li className="w-full px-2">
                    <button type="button" onClick={handleSignIn} className="w-full flex h-11 items-center justify-center rounded-md bg-[#D64937] hover:bg-opacity-90">
