            ...
            <table className="w-full">
                <thead className="bg-gray-100 text-start text-sm font-semibold uppercase">
                    <tr className="whitespace-nowrap">
                        <th className="p-2 text-gray-700 w-6/12 rounded-tl-lg">Brand & Model</th>
                        <th className="p-2 text-gray-700 w-1/12">Quantity</th>
                        <th className="p-2 text-gray-700 w-2/12">Unit Price</th>
                        <th className="p-2 text-gray-700 w-2/12 rounded-tr-lg">Total Price</th>
                    </tr>
                </thead>
                <tbody>
...
export default async function InvoicePage({ params }: { params: { salesId: string } }) {
    ...
    const salesEntry = await getSalesIndividual(salesId);
                    ...
                    <div className="flex flex-col rounded-xl bg-white p-4 sm:p-10">
                        <div className="flex justify-between">
                            ...
                            <div className="text-end">
                                ...
                                <address className="mt-3 not-italic text-gray-800 whitespace-nowrap">Boro Masjid Road, Melandaha Bazar</address>
                                <p className="block text-sm font-medium text-gray-800 mt-1">
